...
const page = usePage();
const clients = computed(() => page.props.movements);
...
function destroy(id) {
    if (confirm("Are you sure you want to delete?")) {
        form.delete(route('movement.destroy', id));
            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">List of Movements</h3>
                    </div>
                                        ...
                                        <div class="d-flex">
                                            <div class="align-self-center">
                                                <table>
                                                    <tr>
                                                        <td colspan="2">
                                                            <Link :href="route('movement.create')">
                                                                <button type="button" class="btn btn-primary btn-rounded"><i class="mdi mdi-plus"></i> Add New Movement</button>
                                                            </Link>
                                                        </td>
                                                    </tr>
                                                </table>
